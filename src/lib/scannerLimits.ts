...
export const SCANNER_LIMITS = {
  maxZipSizeBytes: 2 * 1024 * 1024 * 1024,
  maxFileCount: 100_000,
  maxArchiveEntryCount: 100_000,
  maxDeclaredUncompressedBytes: 10 * 1024 * 1024 * 1024,
  maxArchiveEntryUncompressedBytes: 512 * 1024 * 1024,
  maxCompressionRatio: 250,
  maxReadableTextFileSizeBytes: 300 * 1024,
  maxTotalReadableTextBytes: 2 * 1024 * 1024,
  maxSelectedTextFiles: 320,
  maxPathLength: 240,
...
export function createEmptyScanSummary(): ScanSummary {
  return {
    ...
    analyzedTextFiles: 0,
    analyzedTextBytes: 0,
    oversizedTextFilesIgnored: 0,
    unsupportedFilesIgnored: 0,
    unreadableTextFilesIgnored: 0,
    budgetExcludedFiles: 0,
    boundedReasons: [],
    selectionPolicyVersion: 'shipseal.evidence-selection.v2',
    representedFiles: 0,
    filesAnalyzed: 0,
    filesIgnored: 0,
