...
export function ResultChapterNav({
  ...
  return (
    <nav className="mb-2" aria-label="Result chapters">
      <div className="grid grid-cols-2 gap-2 sm:grid-cols-4">
        ...
        <button
          ...
          className={`rounded-lg border px-3 py-1.5 text-left transition focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring ${
