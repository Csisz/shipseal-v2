...
function emptyDiagnostics(): Omit<RepositoryUniverseDiagnosticsSnapshot, 'rendererCreationCount' | 'rendererDisposalCount' | 'canvasId'> {
  return {
    ...
    revealScheduleNodeCount: 0,
    revealScheduleEdgeCount: 0,
    revealDurationTarget: 0,
    revealedNodeCount: 0,
    revealedEdgeCount: 0,
    revealScheduleGenerationCount: 0,
    activeHeatmapDimension: null,
    ...
    heatmapModelGenerationCount: 0,
    heatmapTargetRecalculationCount: 0,
    heatmapLegendLow: null,
    heatmapLegendHigh: null,
    routeNodeCount: 0,
    routeEdgeCount: 0,
    routeActive: false,
    activeRouteNodeCount: 0,
    activeRouteEdgeCount: 0,
    routeEnergyEligibleEdgeCount: 0,
    routeEnergyPulseCapacity: 0,
    ...
    routeEnergyReducedMotion: false,
