...
Target users are AI freelancers, small AI agencies, no-code/low-code AI builders, indie SaaS teams, and consultants delivering AI automations to clients. The public billing plans are Free and Pro; older workflow package names remain product-path concepts rather than purchasable plans.
